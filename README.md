...
There is a decent amount of setup require in the Google Cloud Console, but also some research was required on how to call each API. 
...
display how many steps the user has remaining to walk to dismiss the alarm. 
...
the application would randomly sleep overnight. I had assume that a foreground service would remain running even if the phone was in deep sleep. This turned out  
